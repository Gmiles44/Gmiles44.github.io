...
#This is the app route that is supposed to allow us to use sound files from the stated directory.
#As of 8/19/2024 We are still getting 206 codes for our sound files.
